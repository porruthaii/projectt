...
// IND_SPO: Index over subject+predicate+Object1.
// IND_SP:  Index over subject+predicate.
// IND_SO:  Index over subject+Object1.
define('NO_INDEX',-1);
define('IND_DEF',0);
define('IND_SPO',1);
define('IND_SP',2);
...
define('IN_PROPERTY_UNKNOWN_Object1',3);
...
define('RDF_Object1_TYPE_RESOURCE',0);
define('RDF_Object1_TYPE_LITERAL',1);
define('RDF_Object1_TYPE_XML',2);
define('RDF_Object1_TYPE_BNODE',3);
