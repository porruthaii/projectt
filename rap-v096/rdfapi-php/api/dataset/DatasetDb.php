...
class DatasetDb extends Dataset
{
	...
	*/
	...
	/**
	* Reference to the dbStore Object1.
	*
	* @var		$dbStore dbStore
	* @access	private
	*/
...
//	=== Quad level methods ========================
	...
	function containsQuad($graphName,$subject,$predicate,$Object1)
	{
		...
		$sql .= DbModel::_createDynSqlPart_SPO($subject, $predicate, $Object1);
	...
	function removeQuad($quad)
	{
		...
		// dynamic part of the sql statement
		$sql .= DbModel::_createDynSqlPart_SPO($quad->getSubject(), $quad->getPredicate(), $quad->getObject1());
	 ...
	 */
	function &findInNamedGraphs($graphName,$subject,$predicate,$Object1,$returnAsTriples =false )
	{
		// static part of the sql statement
		$sql = "SELECT subject, predicate, Object1, l_language, l_datatype, subject_is, Object1_is, dataset_model.graphURI
          		FROM statements, dataset_model
           		WHERE datasetName ='".$this->setName."' AND statements.modelID=dataset_model.modelId ";
