...
//	=== Quad level methods ========================
	 ...
	 * @param Resource $Object1
	 * @return boolean
	 */
	function containsQuad($graphName,$subject,$predicate,$Object1)
	{
		if($graphName!=null)
		{
			...
			return ($this->graphs[$graphName->getLabel()]->findFirstMatchingStatement($subject,$predicate,$Object1)!=null);
		}

		foreach ($this->graphs as $graph)
		{
			if ($graph->findFirstMatchingStatement($subject,$predicate,$Object1)!=null)
				return true;
		};
	 ...
	 * @return Iterator
	 */
	function &findInNamedGraphs($graph,$subject,$predicate,$Object1,$returnAsTriples = false)
	{
		...
		if ($graph!=null)
		{
			...
			return $findGraph->iterFind($subject,$predicate,$Object1);
		}


        require_once RDFAPI_INCLUDE_DIR . 'dataset/IteratorFindQuadsMem.php';
        $m = new IteratorFindQuadsMem($subject,$predicate,$Object1,$this->listNamedGraphs(),$returnAsTriples);
        return $m;
	}
	 ...
	 * @return Iterator
	 */
	function &findInDefaultGraph($subject,$predicate,$Object1)
	{
		return $this->defaultGraph->iterFind($subject,$predicate,$Object1);
	}
}
?>