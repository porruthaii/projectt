...
class IteratorFindQuadsMem
{
	...
	*/
	...
	/**
	* The Object1 Resource to search for.
	*
	* @var string
	* @access	private
	*/
    ...
    * Constructor.
    *
	* $subject, $predicate, and $Object1 are used like find().
	...
	* @access	public
    */
	function IteratorFindQuadsMem($subject,$predicate,$Object1,&$graphIterator, $returnAsTriples=false)
	{
		$this->findSubject=$subject;
		$this->findPredicate=$predicate;
		$this->findObject1=$Object1;
    ...
    */
	function next()
	{
		...
		$this->current= $currentGraph->findFirstMatchingStatement($this->findSubject,$this->findPredicate,$this->findObject1,++$this->graphKey);
    ...
    */
	function current()
	{
		...
		$currentGraph=&$this->graphIterator->current();
		return new Quad(new Resource($currentGraph->getGraphName()),$this->current->getSubject(),$this->current->getPredicate(),$this->current->getObject1());
	}
