...
class Quad  
{
	...
	* @access	public
    */		
	function Quad($graphName,$subject,$predicate,$Object1)
	{
		...
		$this->statement=new Statement($subject,$predicate,$Object1);
    ...
    */
	function getObject1()
	{
		return $this->statement->getObject1();	
	}
		
	/**
    * Returns the statement(subject,predicate,Object1).
    *
    * @return statement
	* @access	public
    */
