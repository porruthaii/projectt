 ...
 */
 function DbStore ($dbDriver=ADODB_DB_DRIVER, $host=ADODB_DB_HOST, $dbName=ADODB_DB_NAME,
   ...
   // create a new connection Object1
 ...
 function _createUniqueDatasetID() {
    ...
    protected function _createTables_MsAccess()
    {
        ...
        $this->dbConn->execute('CREATE TABLE statements
                                (modelID long,
                                    ...
                                    Object1_is varchar(1),
                                    primary key (modelID, subject, predicate, Object1,
        ...
        $this->dbConn->execute('CREATE INDEX s_obj_idx ON statements (Object1)');
    ...
    */
    function _createTables_MySQL()
    {
        ...
        $this->dbConn->execute('CREATE INDEX s_obj_idx ON statements (Object1(250))');

        $this->dbConn->execute('CREATE FULLTEXT INDEX s_obj_ftidx ON statements (Object1)');
    ...
    */
    function _createTables_MSSQL()
    {
        ...
        $this->dbConn->execute("CREATE TABLE [dbo].[statements] (
                                    ...
                                    [Object1] [text] COLLATE SQL_Latin1_General_CP1_CI_AS NULL ,
                                    ...
                                    [Object1_is] [nchar] (1) COLLATE SQL_Latin1_General_CP1_CI_AS NULL
