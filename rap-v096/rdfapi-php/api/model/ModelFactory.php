...
class ModelFactory
{
	...
	function &getOntModelForBaseModel(&$baseModel, $vocabulary)
	{
		...
		switch ($vocabulary)
		{
			case RDFS_VOCABULARY:
				...
				$vocab_Object1 = new RdfsVocabulary();
				break;
			default:
		...
		$mod = new OntModel($baseModel, $vocab_Object1);
		return $mod;
	}
	...
	* @return	SparqlClient the SparqlClient Object1.
	* @access	public
	*/
