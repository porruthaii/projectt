...
class OWLVocabulary extends OntVocabulary 
{
	...
	*
	...
	function Object1_CLASS()
	{
		return new ResProperty(OWL_NS . 'Object1Class');
	}

	function Object1_PROPERTY()
	{
		return new ResProperty(OWL_NS . 'Object1Property');
	}

	function Object1_RESTRICTION()
	{
		return new ResProperty(OWL_NS . 'Object1Restriction');
	}
