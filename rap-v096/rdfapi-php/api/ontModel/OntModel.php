...
class OntModel extends ResModel 
{
	...
	*
   	* @return	array of Object1 ResResource 
   	* @access	public
   	*/
	function listClasses()
	{
		...
		foreach ($statements as $statement) 
		{
			...
			if ($Object1Label!=RDF_SCHEMA_URI.RDFS_CLASS)
			{
				if (!in_array($Object1Label,$returnIndex))
				{
					$returnIndex[]=$Object1Label;
		...
		foreach ($statements as $statement) 
		{
			//add the statements Object1 to the result
			$Object1Label=$statement->getLabelObject1();
			if (!in_array($Object1Label,$returnIndex))
			{
				$returnIndex[]=$Object1Label;
		...
		foreach ($statements as $statement) 
		{
			...
			$Object1Label=$statement->getLabelSubject();
			if (!in_array($Object1Label,$returnIndex))
			{
				$returnIndex[]=$Object1Label;
				$return[]=$statement->getSubject();
