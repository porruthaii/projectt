...
class OntResource extends ResResource 
{
	...
	*
   	* @param	Object1 OntVocabulary	$vocabulary
   	* @access	public
   	*/
	...
	*
   	* @param	Object1 ResLiteral	$comment
   	* @return	boolean 
   	* @access	public
   	*/
	...
	/**
	* Answer the comment string for this Object1. If there is more than one such resource, an arbitrary selection is made.
	*
   	* @return	Object1 ResLiteral or NULL 
   	* @access	public
   	*/
	function getComment()
	{
	...
	*
   	* @param	Object1 ResResource	$resResource
   	* @return	boolean 
   	* @access	public
   	*/
	...
	*
   	* @param	Object1 ResLiteral	$resLiteral
   	* @return	boolean 
   	* @access	public
   	*/
	...
	/**
	* Answer the label ResLiteral for this Object1. 
	* If there is more than one such resource, an arbitrary selection is made.
	*
   	* @param	string	$uri
   	* @return	Object1 ResResource
	...
	*
	...
	function getPropertyValue($property, $returnType = 'ResResource')
	{
		...
		if ($statement===null)
			...
			{
				case 'OntClass':
					return $this->model->createOntClass($statement->getLabelObject1());		
					break;
					
				case 'OntProperty':
					return $this->model->createOntProperty($statement->getLabelObject1());		
					break;
				
				case 'Individual':
					return $this->model->createIndividual($statement->getLabelObject1());		
					break;
			
				default:
					return $statement->getObject1();
					break;	
			}	
	}
	...
	*
   	* @param	Object1 ResResource	$ontClass
   	* @return	boolean 
   	* @access	public
   	*/
	...
	*
   	* @param	Object1 ResResource	$startResource
   	* @param	Object1 ResResource	$attribute
	* @param	array				$attribute
	* @param	Object1 ResResource	$onlyFindThisResResource	
	...
	function _getSuperAttributeStatementsRec(& $startResource,& $attribute,& $attributeIndex, $onlyFindThisResResource = false)
	{
		...
		if ($onlyFindThisResResource)
		{
			...
			{
				if ($onlyFindThisResResource->equals($statement->getObject1()))
					return true;
			}	
		}
		...
		foreach ($return as $statement)
		{
			$attributeLabel=$statement->getLabelObject1();
			if (!in_array($attributeLabel,$attributeIndex))
			{
				$attributeIndex[]=$attributeLabel;
				$subReturn = $this->_getSuperAttributeStatementsRec($statement->getObject1(), $attribute, $attributeIndex, $onlyFindThisResResource);
			} 
		}
		if (isset($subReturn))
		{
    ...
    *
    * @return Object1 ResResource $resResource 
	* @access	public
    */
