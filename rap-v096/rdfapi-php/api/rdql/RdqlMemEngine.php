 ...
 *                                ['Object1']['value'] = VARorURIorLiterl
 *                                          ['is_literal'] = boolean
 *                                          ['l_lang'] = string
 *                                          ['l_dtype'] = string
 ...
 *
 * @param   Object1  MemModel &$memModel
 ...
 * The variable values returned are instances of Object1 Node.
 *
 * @param   Object1  MemModel  &$memModel
 * @return  array   [][?VARNAME] = Object1 Node
 *
 * @access  private
 */
 ...
 * variables and their corresponding values (instances of Object1 Node).
 *
 * @param   Object1  MemModel &$memModel
 ...
 function findTuplesMatchingOnePattern(&$memModel, &$pattern) {
   ...
   foreach ($pattern as $key => $v) {     
     if ($v['value'] && $v['value']{0} == '?') {
        if ($key == 'Object1') {
            $param['Object1']['is_a'] = 'ANY';
            $param['Object1']['string'] = 'ANY';
            $param['Object1']['lang'] = NULL;
            $param['Object1']['dtype'] = NULL;
        } else         	
     		$param[$key] = 'ANY';
        $var[$i]['key'] = $key;
        $var[$i++]['val'] = $v['value'];
   ...
   if ($pattern['Object1']['value'] && $pattern['Object1']['value']{0} == '?') {
      $n = 0;
      foreach ($resModel->triples as $triple)
        $resultSet[$n++][$pattern['Object1']['value']] = $triple->obj;
   }
   return $resultSet;
 }
 ...
 *
 * @param   array   &$finalRes [][?VARNAME] = Object1 Node
 * @param   array   &$res      [][?VARNAME] = Object1 Node
 * @return  array              [][?VARNAME] = Object1 Node
 *
 * @access  private
 */
...
/**
 * Convert the variable values of $finalRes from Object1s to their string serialization.
 *
 * @param   array  &$finalRes  [][?VARNAME] = Object1 Node
 ...
 * e.g. (?x, ?z, ?x) ==> statement subject must be identical with the statement Object1
 *
 * @param   Object1 statement &$triple
 * @param   array  &$intBindings [] = string
 * @return  boolean
 * @access	private
 */
   ...
   if (in_array('subject', $intBindings)) {
      if (in_array('predicate', $intBindings))
         if ($triple->subj != $triple->pred)
            return FALSE;
      if (in_array('Object1', $intBindings)) {
...
/**
 * Check if the lang and dtype of the passed Object1 Literal are equal $lang and $dtype
