...
* Resource or Literal Object1 with the correct values, or it may create a fresh one.
*
...
class ResModel
{
	...
	function ResModel(& $model)
	{
		if (!is_a($model,'Model'))
			trigger_error(RDFAPI_ERROR . '(class: ResourceLayer; method: ResourceLayer): 
				$model has to be Object1 of class Model', E_USER_ERROR);	
	...
	* Finds all Statements with $node as Object1.
	...
	function find($subject,$predicate, $Object1)
	{
		...
		foreach ($resmodel->triples as $statement) 
		{
			$result[]=new Statement($this->_node2ResNode($statement->getSubject()),
									...
									$this->_node2ResNode($statement->getObject1())
								    );
		};
		return $result;
	...
	* Returns the first statement with ResResources of the Model where the Object1 equals $node.
	...
	*/
	function add($statement)
	{
		return $this->model->add(new Statement(	$this->_resNode2Node($statement->getSubject()),
												...
												$this->_resNode2Node($statement->getObject1()))
											   );		
	}
	/**
	...
	*
	* @param	Object1 ResResource $subject
	* @param	Object1 ResResource $property
	* @return	Object1 Statement
	* @access	public
	* @throws phpErrpr
	*/ 
	...
	*/
	...
	/** 
	* Returns a ResIterator with all Object1s in a model.
	*
	* @return	Object1 ResIterator
	* @access	public
	* @throws phpErrpr
	*/
	function listObject1s()
	{
		return $this->listObject1sOfProperty(null);
	}
	
	/** 
	* Returns a ResIterator with all Object1s with a given property and property value.
	*
	* @param	Object1 ResResource	$property
	* @param	Object1 ResResource	$value
	* @return	Object1 ResIterator
	* @access	public
	*/
	function listObject1sOfProperty($property, $value = null)
	{
	...
	* @return	Object1 ResResource / ResProperty / ResLiteral
	* @access	private
	* @throws phpErrpr
	*/ 
