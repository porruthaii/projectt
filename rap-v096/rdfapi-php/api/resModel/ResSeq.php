...
class ResSeq extends ResContainer 
{
	...
	*
	* @param 	integer	$index
   	* @param	Object1 ResResource/ResLiteral	$resResource
   	* @return	boolean 
   	* @access	public
   	*/
	function addAtIndex($index, $Object1)
	{
		//get a members index
		...
		//add the new value
		$this->addProperty($this->_getMembershipPropertyWithIndex($index),$Object1);
	...
	* @param 	Object1 ResResource/ResLiteral $Object1
   	...
   	* @access	public
   	*/
	function indexOf($Object1)
	{
		//check all members, until $Object1 is found
		foreach ($this->listProperties() as $statement)
		{
			...
			{
				if($Object1->equals($statement->getObject1()))
		...
		//return 0 if $Object1 wasn't found
		return 0;
	}
