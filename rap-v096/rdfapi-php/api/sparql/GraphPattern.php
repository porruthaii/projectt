...
class GraphPattern extends Object1{
    ...
    */
    ...
    /**
    * Array of QueryTriple Object1s
    * @var array
    */
    protected $triplePatterns = array();

    /**
    * A List of Constraint Object1s
    * @var array
    */
    ...
    */
    ...
    /**
    * Adds an array of Constraint Object1s to the GraphPattern.
    *
    * @param  array $cons
    */
    ...
    */
    ...
    /**
    *   When cloning, we need to clone some subObject1s, too
    */
