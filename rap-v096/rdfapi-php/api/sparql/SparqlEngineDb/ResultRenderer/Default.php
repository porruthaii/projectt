...
class SparqlEngineDb_ResultRenderer_Default implements SparqlEngineDb_ResultRenderer
{
    ...
    */
    protected $arCreationMethods = array(
        ...
        'o' => 'createObject1FromDbRecordSetPart'
    );
    ...
    *   @param Query $query     SPARQL query Object1
    ...
    */
    ...
    /**
    *   Converts a ADORecordSet Object1 into an array of "rows" that
    ...
    */
    ...
    /**
    *   Creates an RDF Statement Object1 for one of the variables
    *   contained in the given $dbRecordSet Object1.
    *
    ...
    *
    *   @return Statement   RDF statement Object1
    */
    protected function createStatementFromDbRecordSetPart(ADORecordSet $dbRecordSet, $strVarBase)
    {
        return new Statement(
            ...
            $this->createObject1FromDbRecordSetPart   ($dbRecordSet, $strVarBase)
        );
    }//protected function createStatementFromDbRecordSetPart(ADORecordSet $dbRecordSet, $strVarBase)
    ...
    /**
    *   Creates an RDF subject Object1
    *   contained in the given $dbRecordSet Object1.
    *
    *   @see convertFromDbResult() to understand $strVarBase necessity
    *
    ...
    *   @param string       $strVarBase     Prefix of the columns the recordset fields have.
    *
    *   @return Resource   RDF triple subject resource Object1
    */
    ...
    /**
    *   Creates an RDF predicate Object1
    *   contained in the given $dbRecordSet Object1.
    *
    *   @see convertFromDbResult() to understand $strVarBase necessity
    *
    ...
    *   @param string       $strVarBase     Prefix of the columns the recordset fields have.
    *
    *   @return Resource   RDF triple predicate resource Object1
    */
    ...
    /**
    *   Creates an RDF Object1 Object1
    *   contained in the given $dbRecordSet Object1.
    *
    *   @see convertFromDbResult() to understand $strVarBase necessity
    *
    ...
    *   @param string       $strVarBase     Prefix of the columns the recordset fields have.
    *
    *   @return Resource   RDF triple Object1 resource Object1
    */
    protected function createObject1FromDbRecordSetPart(ADORecordSet $dbRecordSet, $strVarBase, $strVar)
    {
        $strVarName = (string)$strVar;
        if ($dbRecordSet->fields[$strVarBase . '.' . $this->sg->arVarAssignments[$strVarName]['sql_value']] === null) {
            //FIXME: should be NULL, but doesn't pass test
        ...
        switch ($dbRecordSet->fields[$strVarBase . '.' . $this->sg->arVarAssignments[$strVarName]['sql_is']]) {
            case 'r':
                $Object1 = new Resource ($dbRecordSet->fields[$strVarBase . '.' . $this->sg->arVarAssignments[$strVarName]['sql_value']]);
                break;
            case 'b':
                $Object1 = new BlankNode($dbRecordSet->fields[$strVarBase . '.' . $this->sg->arVarAssignments[$strVarName]['sql_value']]);
                break;
            default:
                $Object1 = new Literal(
                ...
                if ($dbRecordSet->fields[$strVarBase . '.' . $this->sg->arVarAssignments[$strVarName]['sql_type']]) {
                    $Object1->setDatatype($dbRecordSet->fields[$strVarBase . '.' . $this->sg->arVarAssignments[$strVarName]['sql_type']]);
                }
        }
        return $Object1;
    }//protected function createObject1FromDbRecordSetPart(ADORecordSet $dbRecordSet, $strVarBase, $strVarName)
