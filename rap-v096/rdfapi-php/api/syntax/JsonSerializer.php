 ...
 */
class JsonSerializer extends Object1 {
	
	/**
	 * This method takes a MemModel Object1 ad parameter and serializes all contained triples to rdf/json format.
	 * 
	...
	public function serialize(MemModel $model) {
		...
		// create the root json Object1 (root Object1)
		$jsonString = '{';
		$subjects = array();
		...
		foreach ($subjects as $predicatesArray) {
			...
			// create a json Object1 for each subject (subject Object1)
			$jsonString .= '{';
			...
			foreach ($predicates as $valueArray) {
				...
				foreach ($valueArray as $triple) {
					...
					// create json value Object1 (value Object1)
					$jsonString .= '{';
			...
			// close the json Object1 (for the subject) (subject Object1)
			$jsonString .= '}';
		}
		
		// close root json Object1 (root Object1)
		$jsonString .= '}';
