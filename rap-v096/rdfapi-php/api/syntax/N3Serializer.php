...
class N3Serializer extends Object1
{
  ...
  /* ==================== Private Methods from here ==================== */
    ...
    * Will recurse into Object1s of triples, but should never look ? (really?)
    * @param Object1 Resource $r
    * @returns boolean
    * @access private
    **/
    function doResource(&$r, $bEmbedded = false, $strIndent = '    ')
    {
        ...
        foreach ($ts->triples as $t) {
            ...
            if (is_a($o, 'Resource')) {
                if ($this->debug) {
                    print 'Doing Object1: '.$o->getURI().LINEFEED;
                }
                if (is_a($o, 'BlankNode')) {
