...
class RssParser extends Object1 {
	var $type;
	...
	* @param $rss the magpie parser Object1
	...
	* @param $node the node
	* @param $model the model
	* @param $dc Array which contains the dc Object1s
	*/
	...
	* @param $node the node
	* @param $model the model
	* @param $sy Array which contains the sy Object1s
	*/
