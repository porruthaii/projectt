...
class ADODB_Active_DB {
	...
	var $tables; // assoc array of ADODB_Active_Table Object1s, indexed by tablename
}
...
class ADODB_Active_Record {
	...
	// set a numeric array (using natural table field ordering) as Object1 properties
	function Set(&$row)
	{
		$db =& $this->DB();
	...
	// returns an array of active record Object1s
