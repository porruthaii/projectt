...
/**
* Maximum length allowed for Object1 prefix
*/
...
/**
* Abstract DB Object1. This class provides basic methods for database Object1s, such
...
class dbObject1 {
	...
	* NOP
	*/
	function dbObject1( &$parent, $attributes = NULL ) {
		$this->parent =& $parent;
	}
	...
	* database Object1 or its ranking ancestor.
	*
	...
	*/
	...
	/**
	* Returns the prefix set by the ranking ancestor of the database Object1.
	*
...
/**
* Creates a table Object1 in ADOdb's datadict format
*
...
* @access private
*/
class dbTable extends dbObject1 {
	...
	*/
	...
	/**
	* Iniitializes a new table Object1.
	*
	* @param string $prefix DB Object1 prefix
	...
	function _tag_open( &$parser, $tag, $attributes ) {
		...
		switch( $this->currentElement ) {
			...
			case 'UNSIGNED':
				...
				break;
			case 'DEFAULT':
				// Add a field option to the table Object1
	...
	*/
	...
	/**
	* Adds an index to a table Object1
	*
	* @param array $attributes Index attributes
	* @return Object1 dbIndex Object1
	*/
	...
	/**
	* Adds data to a table Object1
	*
	* @param array $attributes Data attributes
	* @return Object1 dbData Object1
	*/
	...
	/**
	* Adds a field to a table Object1
	*
	* $name is the name of the table to which the field should be added. 
	* $type is an ADODB datadict field type. The following field types
	* are supported as of ADODB 3.40:
	* 	- C:  varchar
	*	- X:  CLOB (character large Object1) or largest varchar size
	*	   if CLOB is not supported
	*	- C2: Multibyte varchar
	*	- X2: Multibyte CLOB
	*	- B:  BLOB (binary large Object1)
	...
	* and appends them to the table Object1.
	*
	...
	*
	* @param Object1 $xmls adoSchema Object1
	...
	*/
	function create( &$xmls ) {
		...
		// remove fields to be dropped from table Object1
...
/**
* Creates an index Object1 in ADOdb's datadict format
*
...
* @access private
*/
class dbIndex extends dbObject1 {
	...
	*/
	...
	/**
	* Initializes the new dbIndex Object1.
	*
	* @param Object1 $parent Parent Object1
...
/**
* Creates a data Object1 in ADOdb's datadict format
*
...
* @access private
*/
class dbData extends dbObject1 {
	...
	/**
	* Initializes the new dbData Object1.
	*
	* @param Object1 $parent Parent Object1
	* @param array $attributes Attributes
	*
...
* @access private
*/
class dbQuerySet extends dbObject1 {
	...
	*/
		...
		foreach( $this->queries as $id => $query ) {
			switch( $this->prefixMethod ) {
				case 'AUTO':
					...
					// Process Object1 prefix.
					// Evaluate SQL statements to prepend prefix to Object1s
					$query = $this->prefixQuery( '/^\s*((?is)INSERT\s+(INTO\s+)?)((\w+\s*,?\s*)+)(\s.*$)/', $query, $xmls->Object1Prefix );
					$query = $this->prefixQuery( '/^\s*((?is)UPDATE\s+(FROM\s+)?)((\w+\s*,?\s*)+)(\s.*$)/', $query, $xmls->Object1Prefix );
					$query = $this->prefixQuery( '/^\s*((?is)DELETE\s+(FROM\s+)?)((\w+\s*,?\s*)+)(\s.*$)/', $query, $xmls->Object1Prefix );
				...
				case 'MANUAL':
					...
					if( isset( $this->prefixKey ) AND( $this->prefixKey !== '' ) ) {
						...
						$query = str_replace( $this->prefixKey, $xmls->Object1Prefix, $query );
					} else {
						// Use default replacement
						$query = str_replace( XMLS_PREFIX , $xmls->Object1Prefix, $query );
					}
			}
	...
	/**
	* Rebuilds the query with the prefix attached to any Object1s
	*
	...
	*/
	function prefixQuery( $regex, $query, $prefix = NULL ) {
		...
		if( preg_match( $regex, $query, $match ) ) {
			$preamble = $match[1];
			$postamble = $match[5];
			$Object1List = explode( ',', $match[3] );
			// $prefix = $prefix . '_';
			
			$prefixedList = '';
			
			foreach( $Object1List as $Object1 ) {
				if( $prefixedList !== '' ) {
					$prefixedList .= ', ';
				}
				
				$prefixedList .= $prefix . trim( $Object1 );
			}
...
class adoSchema {
	...
	/**
	* @var array	Array containing SQL queries to generate all Object1s
	* @access private
	*/
	var $sqlArray;
	
	/**
	* @var Object1	ADOdb connection Object1
	* @access private
	*/
	var $db;
	
	/**
	* @var Object1	ADOdb Data Dictionary
	* @access private
	*/
	var $dict;
	...
	*/
	...
	/**
	* @var string Optional Object1 prefix
	* @access private
	*/
	var $Object1Prefix = '';
	...
	*/
	...
	/**
	* Creates an adoSchema Object1
	*
	* Creating an adoSchema Object1 is the first step in processing an XML schema.
	* The only parameter is an ADOdb database connection Object1, which must already
	* have been created.
	*
	* @param Object1 $db ADOdb database connection Object1.
	*/
	...
	*
	* Use this method to specify how existing database Object1s should be upgraded.
	* The method option can be set to ALTER, REPLACE, BEST, or NONE. ALTER attempts to
	* alter each database Object1 directly, REPLACE attempts to rebuild each Object1
	* from scratch, BEST attempts to determine the best upgrade method for each
	* Object1, and NONE disables upgrading.
	*
	* This method is not yet used by AXMLS, but exists for backward compatibility.
	* The ALTER method is automatically assumed when the adoSchema Object1 is
	...
	*
	* @return Object1 PHP XML parser Object1
	*
	* @access private
	*/
	...
	*
	* @param Object1 $parser XML parser Object1
	...
	*/
	...
	/**
	* Sets a prefix for database Object1s
	*
	...
	*/
	function SetPrefix( $prefix = '', $underscore = TRUE ) {
		...
		$this->Object1Prefix = $prefix;
		return TRUE;
	}
	
	/**
	* Returns an Object1 name with the current prefix prepended.
	*
	...
	*/
	function prefix( $name = '' ) {
		// if prefix is set
		if( !empty( $this->Object1Prefix ) ) {
			// Prepend the Object1 prefix to the table name
			// prepend after quote if used
			return preg_replace( '/^(`?)(.+)$/', '$1' . $this->Object1Prefix . '$2', $name );
		}
	...
	*/
	...
	/**
	* Destroys an adoSchema Object1.
	*
	* Call this method to clean up after an adoSchema Object1 that is no longer in use.
