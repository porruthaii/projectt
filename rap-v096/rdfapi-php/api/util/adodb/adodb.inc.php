...
*/
	...
	/**
	 * Connection Object1. For connecting to databases, and executing queries.
	 */ 
	class ADOConnection {
	//
	// PUBLIC VARS 
...
*/
	...
	/**
	 * List columns in a database as an array of ADOFieldObject1s. 
	 * See top of file for definition of Object1.
	 *
	 * @param $table	table name to query
	 * @param $normalize	makes table name case-insensitive (required by some databases)
	 * @schema is optional database schema to use - not supported by all databases.
	 *
	 * @return  array of ADOFieldObject1s for current table.
	 */
	...
	*/
	...
	/**
	* Internal placeholder for record Object1s. Used by ADORecordSet->FetchObj().
	*/
	class ADOFetchObj {
	};
   ...
   /**
	...
	var $sql; 				/// sql text
	var $EOF = false;		/// Indicates that the current record position is after the last record in a Recordset Object1. 
   ...
   */
	...
	function Close() 
	{
		// free connection Object1 - this seems to globally free the Object1
	...
	*/
	...
	/**
	 * Get the ADOFieldObject1 of a specific column.
	 *
	 * @param fieldoffset	is the column position to access(0-based).
	 *
	 * @return the ADOFieldObject1 for that column, or false.
	 */
	...
	/**
	 * Get the ADOFieldObject1s of all columns in an array.
	 *
	 */
	...
	/**
	* Return the fields array of the current row as an Object1 for convenience.
	* The default case is lowercase field names.
	*
	* @return the Object1 with the properties set to the fields of the current row
	*/
	function &FetchObj()
	{
		$o =& $this->FetchObject1(false);
		return $o;
	}
	...
	* 
	* @param $isupper to set the Object1 property names to uppercase
	*
	* @return the Object1 with the properties set to the fields of the current row
	*/
	function &FetchObject1($isupper=true)
	{
		if (empty($this->_obj)) {
	...
	* Fixed bug reported by tim@orotech.net
	*/
	function &FetchNextObject1($isupper=true)
	{
		$o = false;
		if ($this->_numOfRows != 0 && !$this->EOF) {
			$o = $this->FetchObject1($isupper);	
			$this->_currentRow++;
	 ...
	 *
	 * @param t  is the type passed in. Normally is ADOFieldObject1->type.
	 * @param len is the maximum length of that field. This is because we treat character
	 * 	fields bigger than a certain size as a 'B' (blob).
	 * @param fieldobj is the field Object1 returned by the database driver. Can hold
	...
	*/
	...
	class ADORecordSet_array extends ADORecordSet
	{
		...
		var $_fieldObject1s; // holds array of field Object1s
		var $canSeek = true;
		...
		global $ADODB_INCLUDED_LIB;
			...
			$fobjs = $addfieldnames ? $this->_fieldObject1s : false;
			...
			$this->_fieldObject1s = array();
			
			foreach($hdr as $k => $name) {
				$f = new ADOFieldObject1();
				$f->name = $name;
				$f->type = $this->_types[$k];
				$f->max_length = -1;
				$this->_fieldObject1s[] = $f;
			}
		...
		/**
		 * Setup the Array and datatype file Object1s
		 *
		 * @param array		is a 2-dimensional array holding the data.
		 *			The first row should hold the column names 
		 *			unless paramter $colnames is used.
		 * @param fieldarr	holds an array of ADOFieldObject1's.
		 */
		...
		function _initrs()
		{
			...
			$this->_numOfFields =(isset($this->_fieldObject1s)) ?
				 sizeof($this->_fieldObject1s):sizeof($this->_types);
		}
		...
		function &FetchField($fieldOffset = -1) 
		{
			if (isset($this->_fieldObject1s)) {
				return $this->_fieldObject1s[$fieldOffset];
			}
	 ...
	 *
	 * @param [db]  is the database Connection Object1 to create. If undefined,
