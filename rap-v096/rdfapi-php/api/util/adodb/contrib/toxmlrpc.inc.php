<?php
    /**
    * Helper functions to convert between ADODB recordset Object1s and XMLRPC values.
    ...
    */    
    ...
    /**
    * Given a well-formed xmlrpc struct Object1 returns an AdoDB Object1
    * 
    ...
    */
    function xmlrpcval2rs (&$xmlrpcval) {
        ...
        // finally build in-memory recordset Object1 and return it
