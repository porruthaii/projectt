...
*/
    ...
    function ServerInfo()
    {
        ...
        not when locating the base Object1 of the search. The LDAP_DEREF_FINDING value means 
        aliases are dereferenced when locating the base Object1 but not during the search.  
