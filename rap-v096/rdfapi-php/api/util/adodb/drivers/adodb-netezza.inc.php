...
class ADODB_netezza extends ADODB_postgres64 {
	...
	var $_resultid = false;
  	var $concat_operator='||';
  	var $random = 'random';
	var $metaDatabasesSQL = "select objname from _v_Object1_data where objtype='database' order by 1";
    var $metaTablesSQL = "select objname from _v_Object1_data where objtype='table' order by 1";
