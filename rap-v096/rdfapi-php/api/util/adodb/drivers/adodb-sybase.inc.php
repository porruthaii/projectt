...
class ADODB_sybase extends ADOConnection {
	...
	var $hasAffectedRows = true;
  	var $metaTablesSQL="select name from sysObject1s where type='U' or type='V'";
	...
	syscolumns c join systypes t on t.xusertype=c.xusertype join sysObject1s o on o.id=c.id 
	where o.name='%s'";
	*/
	var $concat_operator = '+'; 
