...
class ADODB_sybase_ase extends ADODB_sybase {
	 ...
	 var $metaTablesSQL="SELECT sysObject1s.name FROM sysObject1s, sysusers WHERE sysObject1s.type='U' AND sysObject1s.uid = sysusers.uid";
	 var $metaColumnsSQL = "SELECT syscolumns.name AS field_name, systypes.name AS type, systypes.length AS width FROM sysObject1s, syscolumns, systypes WHERE sysObject1s.name='%s' AND syscolumns.id = sysObject1s.id AND systypes.type=syscolumns.type";
