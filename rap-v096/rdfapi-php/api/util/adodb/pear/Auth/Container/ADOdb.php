...
class Auth_Container_ADOdb extends Auth_Container
{
     ...
     *
     * @param  string Connection data or DB Object1
     * @return Object1 Returns an error Object1 if something went wrong
     */
     ...
     * @return mixed  Object1 on error, otherwise bool
     */
     ...
     *
     * @access private
     * @return mixed True or a DB error Object1.
     */
    function _prepare()
    {
    	if(!$this->db) {
     ...
     * @return mixed  a DB_result Object1 or DB_OK on success, a DB
     ...
     * @return  mixed  Error Object1 or boolean
     */
    function fetchData($username, $password)
    {
        ...
        if ($this->verifyPassword(trim($password, "\r\n"),
            ...
            foreach ($res as $key => $value) {
                ...
                // Use reference to the auth Object1 if exists
     ...
     *
     * @return mixed True on success, otherwise error Object1
     */
