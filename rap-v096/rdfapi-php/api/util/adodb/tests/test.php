...
*/
  ...
  KEY `myindex` (`row1`,`row2`)
	...
	if (!is_Object($rs)) {
		print_r($rs);
		err("Update should return Object1");
	} 
 ...
 //////////////////////////////////////////////////////////////////////////////////////////
	...
	print "<p>FetchObject1/FetchNextObject1 Test</p>";
	$rs = $db->Execute('select * from ADOXYZ');
	if ($rs) {
		if (empty($rs->connection)) print "<b>Connection Object1 missing from recordset</b></br>";
		
		while ($o = $rs->FetchNextObject1()) { // calls FetchObject1 internally
	...
	$ADODB_FETCH_MODE = ADODB_FETCH_ASSOC;
	print "<p>FetchObject1/FetchNextObject1 Test 2</p>";
	#$db->debug=99;
	$rs = $db->Execute('select * from ADOXYZ');
	if (empty($rs->connection)) print "<b>Connection Object1 missing from recordset</b></br>";
	print_r($rs->fields);
