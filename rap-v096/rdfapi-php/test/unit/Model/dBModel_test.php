...
class dBModel_test extends UnitTestCase
{
	...
	function testAdd(){
		...
		$mysql_database->putModel($this->_generateModel(),self::$strModelUri);
		$dbmodel=$mysql_database->getModel(self::$strModelUri);
		$statement=new Statement(new Resource('http://www.example.org/subject2'),new Resource('http://www.example.org/predicate2'),new Resource('http://www.example.org/Object12'));
	...
	function testContains(){
		...
		$mysql_database->putModel($this->_generateModel(),self::$strModelUri);
		$dbmodel=$mysql_database->getModel(self::$strModelUri);
		$stat=new Statement(new Resource('http://www.example.org/subject1'),new Resource('http://www.example.org/predicate1'),new Resource('http://www.example.org/Object11'));
		$stat2=new Statement(new Resource('http://www.example.org/subject2'),new Resource('http://www.example.org/predicate2'),new Resource('http://www.example.org/Object12'));
...
//===================================================================
	...
	*/
	...
	function _generateModel(){
		...
		$obj=new Resource('http://www.example.org/Object11');
	...
	function _generateModelLiteral(){
		...
		$sub=new Resource('http://www.example.org/subject1');
		$pred=new Resource('http://www.example.org/predicate1');
		$obj=new Literal('http://www.example.org/Object11');
