...
<body>
    <?php 
 $id = $_GET['id'];
 $user_check_query = "SELECT * FROM restaurant WHERE id = '$id' ";
...
?>
    ...
    <div class="containers">
        <form class="containers" action="" name="frmMain" method="post" target="iframe_target">
            <div class="photos form-control">
                <ul class="nav nav-tabs">
                    <li class="nav-item">
                        <a class="nav-link" href="\projectt\search\menus.php?id=<?php  echo $id ;?>"
                ...
                <iframe class="photo form-control" id="" name="iframe"
                    src="\projectt\search\menus.php?id=<?php  echo $id ;?>"></iframe>
            </div>
        </form>
    </div>
